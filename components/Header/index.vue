    ...
    <Container>
      ...
      <div class="flex gap-2 items-center">
        ...
        <div class="flex gap-4">
          <OButton variant="link" to="login" >
            Entrar
          </OButton>
          
          <OButton class="text-nowrap" to="register">
            Criar conta
          </OButton>
        </div>
        ...
        <div class="flex gap-2 items-center">
            <Menu :isOpen="isOpen">
              <OButton variant="unstyle" class="bg-transparent border-0" @click="toggleMenu">
                <div class="i-carbon-sun dark:i-carbon-moon cursor-pointer text-2xl text-black/50 hover:text-black/80 dark:text-slate-600 dark:hover:text-slate-300"></div>
            </OButton>
            </Menu>
